#define BLYNK_TEMPLATE_ID "TMPLwV0rb9iY"
#define BLYNK_DEVICE_NAME "Suhu dan kelembapan"
#define BLYNK_AUTH_TOKEN "dNx-dBMb-ULIg4z2v8k0kc8XD8KfzkAA"
#define BLYNK_PRINT Serial
const char* ssid     = "SATE";   
const char* password = "linux123";   
char auth[] = BLYNK_AUTH_TOKEN; 
const char* apssid = "SATE";
const char* appassword = "linux123";    
...
<!doctype html>
  ...
  <title>PENDEKTEKSI PENGUNJUNG</title>
  </head>

<body>

<section class="vh-200">
  <div class="container py-8 h-200">
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
          <div class="card shadow-2-strong" style="border-radius: 1rem;">
            <div class="card-body p-5 text-center">

              <h3 class="mb-5">PEENDEKTEKSI PENGUNJUNG</h3>
